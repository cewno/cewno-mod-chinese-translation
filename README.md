[![Crowdin](https://badges.crowdin.net/cewno-mod-chinese-translation/localized.svg)](https://crowdin.com/project/cewno-mod-chinese-translation)  
这是一些我自己翻译的一些模组的语言文件  
Here are some mod language files that I have translated myself.

使用的语言文件的 license 请看[这里](license.md)  
Please refer to [this link](license.md) for the license of the used language file.
